...
$MESS["ORDER_BLOCK_TITLE"] = "Оформление заказа невозможно";
$MESS["ORDER_BLOCK_TEXT"] = "Оформление и доставка заказа осуществляется в рабочее время.";
...
$MESS["ORDER_BLOCK_THEAD_DAY"] = "День недели";
$MESS["ORDER_BLOCK_THEAD_PERIOD_WORK_TIME"] = "Рабочее время";
$MESS["ORDER_BLOCK_THEAD_DAY_OFF"] = "Выходной день";

$MESS["DELIVERY_RADIUS_ERROR"] = "Доставка курьером возможна только внутри выделеной территории";
$MESS["ADDRESS_NOT_FOUND"] = "Адрес не найден";
